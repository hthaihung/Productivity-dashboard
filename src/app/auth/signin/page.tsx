      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full px-4 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg font-medium hover:from-cyan-600 hover:to-blue-600 transition-all shadow-lg shadow-cyan-500/20"
            >
              Sign In
            </button>
          </form>
        ...
        <p className="text-center text-sm text-gray-400">
          ...
          <a href="/auth/signup" className="text-cyan-400 hover:text-cyan-300 font-medium">
            Sign up
          </a>
        </p>
      </div>
